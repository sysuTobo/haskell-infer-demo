...
- `ctest --test-dir csrc/build-libs` runs seven suites that need no GPU at all:
  ...
  sampler's denominator and the trainer's FP32 one; it skips itself when the
  checkpoint is absent, and the
